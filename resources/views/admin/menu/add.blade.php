                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}"
                                      name="description"
                                      id="description"
                                      placeholder="Введите описание для меню">{{ old('description') }}</textarea>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select id="language_id" name="language_id" class="form-control {{ $errors->has('language_id') ? 'is-invalid' : '' }}">
                                    ...
                                    @foreach($languages as $language)
                                        <option {{ (old('language_id')) ? 'selected' : '' }}
                                                value="{{ $language->id }}">
                                            {{ $language->title }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="collapse {{ (old('add_seo')) ? 'show' : ''}}" id="collapse_seo">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="seo_title">
                                        Seo title
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control {{ $errors->has('seo_description') ? 'is-invalid' : '' }}"
                                          name=""
                                          id="seo_description"
                                          placeholder="Введите description для seo">{{ old('seo_description') }}</textarea>
